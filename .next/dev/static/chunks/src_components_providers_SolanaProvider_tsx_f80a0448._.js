...
"[project]/src/components/providers/SolanaProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SolanaProvider({ children }) {
    ...
    const endpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SolanaProvider.useMemo[endpoint]": ()=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) return `https://devnet.helius-rpc.com/?api-key=${apiKey}`;
...
//# sourceMappingURL=src_components_providers_SolanaProvider_tsx_f80a0448._.js.map